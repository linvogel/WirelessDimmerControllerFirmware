...
ssh dimmer "rm -rf /firmware/bin; rm -rf /firmware/shaders; rm /firmware/firmware; rm /firmware/textures; rm -rf /firmware/src"
...
ssh dimmer "mkdir -p /firmware/textures"
...
ssh dimmer "cp -r /firmware/src/textures/* /firmware/textures/"
