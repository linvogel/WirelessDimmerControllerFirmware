...
onscreen_keyboard::onscreen_keyboard(window *window)
{
	...
	// setup dummy model for buttons
	this->m_key_counter = 0;
	this->m_model = model::model();
	this->m_model.add("clear", std::string("X"));
	...
	this->add_key(LOWER, "<-", [this]() { this->backspace(); }, 10, 0, 1);
	...
	this->add_key(LOWER, "^", [this]() { this->shift(); }, 0.0f, 2, 1.0f);
	...
	this->add_key(LOWER, "^", [this]() { this->shift(); }, 10.0f, 2, 1.0f);
	
	this->add_key(LOWER, ".?123", [this]() { this->change(); }, 0.0f, 3, 1.5f);
	this->add_key(LOWER, "", [this]() { this->enter_char(" "); }, 1.5f, 3, 6.9f);
	this->add_key(LOWER, ".?123", [this]() { this->change(); }, 8.0f, 3, 1.5f);
	...
	this->add_key(UPPER, "<-", [this]() { this->backspace(); }, 10.0f, 0, 1.0f);
	...
	this->add_key(UPPER, "^", [this]() { this->shift(); }, 0.0f, 2, 1.0f);
	...
	this->add_key(UPPER, "^", [this]() { this->shift(); }, 10.0f, 2, 1.0f);
	
	this->add_key(UPPER, ".?123", [this]() { this->change(); }, 0.0f, 3, 1.5f);
	this->add_key(UPPER, "", [this]() { this->enter_char(" "); }, 1.5f, 3, 6.9f);
	this->add_key(UPPER, ".?123", [this]() { this->change(); }, 8.0f, 3, 1.5f);
	...
	this->add_key(SYMBOL, "<-", [this]() { this->backspace(); }, 10.0f, 0, 1.0f);
	...
	this->add_key(SYMBOL, "^", [this]() { this->shift(); }, 0.0f, 2, 1.0f);
	...
	this->add_key(SYMBOL, "^", [this]() { this->shift(); }, 10.0f, 2, 1.0f);
	
	this->add_key(SYMBOL, ".?123", [this]() { this->change(); }, 0.0f, 3, 1.5f);
	this->add_key(SYMBOL, "", [this]() { this->enter_char(" "); }, 1.5f, 3, 6.9f);
	this->add_key(SYMBOL, ".?123", [this]() { this->change(); }, 8.0f, 3, 1.5f);
	...
	this->m_clear = new button(&(this->m_model["clear"]), [this]() { this->clear(); }, this->m_window->get_renderer(), 730, 10, 60, 60);
...
{
	char tmp[64];
	snprintf(tmp, 64, "btn_%d", this->m_key_counter++);
...
void onscreen_keyboard::show(model::model_value *value)
{
