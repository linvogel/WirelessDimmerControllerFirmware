...
ssh linvogel "mkdir -p ~/workspace/wireless_firmware_remote/textures"
...
ssh linvogel "cp -r ~/workspace/wireless_firmware_remote/src/textures/* ~/workspace/wireless_firmware_remote/textures/"
